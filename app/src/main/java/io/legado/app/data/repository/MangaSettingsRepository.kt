...
internal fun Preferences.toMangaSettings(): MangaSettings = MangaSettings(
    ...
    doublePageCoverSingle = compatDsBoolean(PreferKey.mangaDoublePageCoverSingle) ?: true,
    doublePageInvert = compatDsBoolean(PreferKey.mangaDoublePageInvert) ?: false,
    doublePageShift = compatDsBoolean(PreferKey.mangaDoublePageShift) ?: false,
